...
import { add_cart, fetch_wishlists, get_cart_items, remove_to_wishlist } from "../components/server/api";
...
const ProductRow = (props) => {
    ...
    return (
        <tr>
            ...
            {!selling_price ? 'Out Stock' : 'In Stock' }
            </span></td>
            <td class="action-col">
                {
                    ...
                    ?
                        ...
                        :
                        <button name="plus" value="1" onClick={handleChange} class="btn btn-block btn btn-primary ca-bt">Add to Cart</button>

                }
                
            </td>
            <td class="action-col">
                <button name="buynow" value="1" onClick={handleChange} class="btn btn-block btn btn-primary bu-bt">Buy Now</button>
            </td>
            <td class="remove-col"><button onClick={()=>remove_wishlist(id)} class="btn-remove"><i class="icon-close"></i></button></td>
        </tr>
    )
}
