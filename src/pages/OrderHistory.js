...
const OrderBody = (props) => {
    const {id,order_items,orderstatus,created_at,is_paid,txn_id,shipping_address_type,payable_amount,shipping_flat,shipping_landmark,shipping_location,shipping_pincode} = props
    return (
                    ...
                    <div class="p-3 rounded shadow-sm bg-white">
                        ...
                        <div class="d-flex">
                            <p class="text-muted m-0">Order ID<br/>
                                <span class="text-dark font-weight-bold">#{id}</span><br/>
                            </p>
                            {
                                is_paid==1 ?
                                <p class="text-muted m-0 ml-auto">Transaction. ID<br/>
