...
const HomeCategoryItem = ({
  ...
  <div
    ...
    style={{ width: "272.5px", marginRight: "10px" }}
  >
          ...
          <div className="align-items-center mt-1">
            <div className="row">
              <div className="bu-box">
                <button type="submit" className="btn buy-btn-2">
                  Buy Now
                </button>
              </div>
              <div className="pri-bo">
                ...
                parseFloat(selling_price) !== 0 ? (
                  <>
                    <h6 className="price m-0  chi-pri">
                      ₹{selling_price}/{unit}
                    </h6>
                    <strike className="pri">
                      {" "}
                      MRP₹{mrp}/{unit}
                    </strike>
                  </>
...
const HomeCategoryItem2 = ({
  ...
  <div
    className="owl-item active swiper-slide"
    data-swiper-slide-index="0"
    style={{ width: "272.5px", marginRight: "10px" }}
  >
    <Link
    ...
    >
      ...
      <span className="content-fire">
        ...
        <span className="plant-description"></span>
...
const HomeSlider = (props) => {
  ...
  const bannerconfig = {
    ...
    nav: true,
    navText: [
      "<i class='icon-angle-left adjust_icon' ></i>",
      "<i class='icon-angle-right adjust_icon' ></i>",
    ],
  };
  ...
  return (
    <div>
      <div className="intro-slider-container">
        <OwlCarousel
          className="owl-theme owl-carousel owl-simple owl-light owl-nav-inside"
          {...bannerconfig}
        >
          {topBanners
            ? topBanners.map((banner) => {
                return <HomeSliderItem image={banner.imageUrl} />;
              })
            : ""}
      ...
      <div className="container">
        {homeCategory.length ? (
          <OwlCarousel
            className="owl-carousel mt-2 owl-simple owl-loaded owl-drag pro-sli pro-new"
            {...options1}
          >
