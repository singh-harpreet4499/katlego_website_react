                    ...
                    <div className="tab-pane-carousel col-sm-12 col-md-6 col-lg-6 px-0">
                        <div className="video-poster">
                            ...
                            >
                                ...
                                <source src={settings.hasOwnProperty('about_us_video') ? settings.about_us_video : 'https://www.youtube.com/watch?v=W0UYKgfQi9k'} type="video/ogg" />
                            ...
                            >
                                <div class="ttm-play-icon-animation ttm-play-icon-animation-skincolor">
                                    ...
                                    <i class="fa fa-play ttm-textcolor-skincolor"
                                    style={{
                                        fontSize: '35px',
