            ...
            <div className="list-card bac-grey h-100 rounded overflow-hidden position-relative shadow-sm">
                <div className="list-card-image">
                    <a href="#" className="text-dark">
                        <div className="p-3">
                            <img src={imageUrl} className="img-fluid item-img w-100 mb-1" alt={title} />
                            <div className="row">
                            ...
                            <div className="align-items-center">
                                <div className="row">
                                    <div className="col-md-6">
                                        <h6 className="easy-pri">{difficulty} | {time}</h6>
                                    </div>
                                    <div className="col-md-6">
                                        <button type="submit" className="btn main-btn">MAIN COURSE</button>
                                    </div>
                                </div>
                            </div>
                        </div>
